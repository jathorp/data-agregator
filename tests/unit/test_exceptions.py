...
class TestUtilityFunctions:
    ...
    def test_is_retryable_error_with_standard_exceptions(self):
        ...
        standard_errors = [ValueError("test"), RuntimeError("test"), Exception("test")]
...
class TestErrorInheritance:
    ...
    def test_validation_error_inheritance(self):
        ...
        validation_error = InvalidConfigurationError("field", "value")
...
class TestErrorSerialization:
    ...
    def test_to_dict_serialization(self):
        ...
        error = S3TimeoutError(
            "GetObject", 30.0, context={"additional": "data"}, correlation_id="test-123"
        )
...
class TestErrorContextHandling:
    ...
    def test_context_with_additional_kwargs(self):
        ...
        error = S3ObjectNotFoundError(
            "test-bucket", "test-key", correlation_id="test-123"
        )
